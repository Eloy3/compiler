...
public class InstructionsList {
    private ArrayList<3aInstruction> inst_list;

    public LlistadInstruccions() {
        inst_list = new ArrayList<>();
    }

    public Instruccioc3a getInstruction(int idx){
        return inst_list.get(idx);
    }

    public void addInst(Operation operation, String op1, String op2, String destination) {

        inst_list.add(new Instruccioc3a(operation, op1, op2, destination));
    }
    ...
    public ArrayList<Instruccioc3a> getInst_list() {
        return inst_list;
    }
    ...
    public String toString() {
        ...
        for (Instruccioc3a inst : inst_list) {
